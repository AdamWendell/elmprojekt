...
validateAge model =
    ...
    in
        if ageInt <= 0 then
            { model | ageError = Just "Age have too be a positive number" }
        else
...
validateBib model =
    ...
    in
        if bibInt <= 0 then
            { model | bibError = Just "Bib have too be a positive number" }
        else
    ...
    Html.form [ class "add-runner", onSubmit Save ]
        [ fieldset []
            ...
            , div []
                ...
                , input
                    [ type_ "text"
                    , Html.Attributes.value model.age
                    , onInput AgeInput
                    ]
                    []
            ...
            , div []
                ...
                , input
                    [ type_ "text"
                    , Html.Attributes.value model.bib
                    , onInput BibInput
                    ]
                    []
